...
class CityTest {
    ...
    @Test
    void findHighestBuildingInCityStreamTest() {
        Building building = city.findHighestBuildingStream();
    ...
    @Test
    void findBuildingsByStreetStreamTest() {

        List<Building> result = city.findBuildingsByStreetStream("Kossuth");
    ...
    @Test
    void testIsThereBuildingWithMorePeopleThanStream() {
        assertTrue(city.isThereBuildingWithMorePeopleThanStream(494));
        assertFalse(city.isThereBuildingWithMorePeopleThanStream(496));
    }
}